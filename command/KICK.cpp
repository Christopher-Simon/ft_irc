...
void Command::KICK(std::string cmd, std::vector<std::string> vect, Server &serv, Client &clt)
{
	...
	else
	{
		...
		serv.send_channel_msg(reply, vect[1], clt.getfd());
